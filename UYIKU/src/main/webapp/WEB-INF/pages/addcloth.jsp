...
<style type="text/css">
	...
	#ca{
		width:100%;
		height:100%;
		border:1px #5599aa solid;
		/* background-color: #eeeeee; */
		background: url("/staticfile/images/photoback.jpg");
...
<div class="Xcontent">
				...
				<ol class="Xcontent13">
					...
					<!-- <div class="Xcontent17"> -->
						...
						<input type="hidden" name="uId" value="${cookie.userId.value}">
							...
							<p class="Xcontent25"><input type="text" name="name"/></p>
						</div>
						&nbsp;
						<div class="Xcontent23">
							...
							<p class="Xcontent25">
								<select name="season">
									<option name="season" >请选择</option>
									<option name="season" value="春秋">春秋</option>
									<option name="season" value="夏">夏</option>
									<option name="season" value="冬">冬</option>
								</select>
							</p>
						</div>
						&nbsp;
					   ...
					   <div class="Xcontent23">
						    ...
						    <p class="Xcontent25">
						    	<select name="style">
									<option name="style" >请选择</option>
									<option name="style" value="运动">运动</option>
									<option name="style" value="休闲">休闲</option>
									<option name="style" value="正式">正式</option>
								</select>
						    </p>
					   </div>
					    &nbsp;
						...
						<p class="Xcontent25">
							<select name="category">
								<option name="category">请选择</option>
								<option name="category" value="上衣">上衣</option>
								<option name="category" value="下衣">下装</option>
								<option name="category" value="鞋">鞋</option>
								<option name="category" value="包">包</option>
								<option name="category" value="饰品">饰品</option>
							</select>
						</p>
					    </div>
					    &nbsp;
		...
		<div id="save">
			<button type="submit"><img alt="" src="/staticfile/images/save.png"></button>
		</div>
		</form>
	</div>
