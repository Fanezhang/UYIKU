...
<body>
	...
	<div id="show">
		<div id="imageFlow">
			...
			<div class="scrollbar">
				<img class="track" src="/staticfile/static/clothImg/track.jpg" alt="">
				<img class="arrow-left" src="/staticfile/static/clothImg/sign_out.png"
					alt=""> <img class="arrow-right"
					src="/staticfile/static/clothImg/sign_in.png" alt=""> <img
					class="bar" src="/staticfile/static/clothImg/bar.jpg" alt="">
			</div>
		</div>
	</div>
</body>
